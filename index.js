...
(function(window, Ember, $, EmberCPM) {
  ...
  EmberCPM.Macros.difference = function(minuend, subtrahend) {
    return Ember.computed(minuend, subtrahend, function difference() {
      return this.get(minuend) - this.get(subtrahend);
    });
  };
